        ...
        <section class="status status--shop dark-bg dark-bg--shop">
            <div class="container wow slideInRight" data-wow-delay="0.7s" data-wow-duration="1.5s">
                <div class="breadcumb">
                    ...
                    <a href="<?php echo base_url('Motocycle_list/category/1') ?>" class="breadcumb__page no-decoration">Shop Categories</a>
                </div>
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-6">
                        ...
                        <div class="shop-main">
                                <header class="shop-main__head clearfix wow fadeInUp" data-wow-delay="0.7s" data-wow-duration="1.5s">
                                    ...
                                    <h4 class="pull-left" ><?php echo $cateGoryName?> Showing <span id="result"><?php echo $productList->num_rows();?></span> results</h4><?php //} ?>
                                </header>
                                        
                            <div class="items">
                                <div class="row">
<?php   $cateGoryID = $this->uri->segment(3);  $limit =''; $notUse ='';
$countAll=$this->Control_model->productListByCate($cateGoryID,$limit,$notUse,'-100','-100');

        $countRow = $countAll->num_rows(); 
        $totalRow = ceil($countRow/$perpage);
foreach ($productList->result() AS $data) {
                                            ...
                                            <div class="item-cell js-cell equal-height-item">
                                                <div class="item-cell__top">
                                                    ...
                                                    <div class="item-cell__actions">
                                                        <a href="<?php echo base_url('Motocycle_list/product_detail/') .$data->motorcycle_category .'/'.$data->id ?>"  class="add-to-cart" >
                                                ...
                                                <div class="item-cell__bottom">
                                                    <h1 class="item-title"><a class="no-decoration" ><?php echo $data->motorcycle_name ?></a></h1>
...
?>
                                            ...
                                            <div class="pagination wow fadeInRight" data-wow-delay="0.7s" data-wow-duration="1.5s">
                                                ...
                                                <span class="pagination__row">
                                                    ...
                                                    ?>
                                                    <a href="<?php echo base_url('Motocycle_list/category/').$cateGoryID.'/'.$page2?> " class="pagination__cell pagination__cell--nav no-decoration">&laquo;</a>
                                    ...
                                    <?php }?>                 
                                                    <a href="<?php echo base_url('Motocycle_list/category/').$cateGoryID.'/'.$page3?> " class="pagination__cell pagination__cell--nav no-decoration">&raquo;</a>
