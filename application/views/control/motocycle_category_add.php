                            ...
                            <div class="card m-b-30 card-body">
                                <h5 class="card-title">
                                    ...
                                    <div class="pull-right">
                                        <button type="button" class="btn btn-success btn-sm" onClick="window.location.href = '<?php echo base_url('control/motocycle_category_add') ?>'"><i class="icon-plus"></i>&nbsp;&nbsp;เพิ่มหมวดสินค้าใหม่</button>
                                        &nbsp;&nbsp;
                                        <button type="button" class="btn btn-info btn-sm" onClick="window.location.href = '<?php echo base_url('control/motocycle_category') ?>'"><i class=" icon-arrow-left-circle"></i>&nbsp;&nbsp;กลับหน้าหมวดสินค้า</button></div>
                                </h5>
