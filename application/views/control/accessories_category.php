                ...
                <div class="page-title-box">
                    <div class="btn-group pull-right">
                        <ol class="breadcrumb hide-phone p-0 m-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo base_url('control/accessories_category') ?>">หมวดสินค้า</a></li>-->
                        </ol>
                    </div>
                            ...
                            <div class="card m-b-30 card-body">
                                <h5 class="card-title">รายชื่อหมวดสินค้า 
                                    <div class="pull-right">
                                        <button type="button" class="btn btn-success btn-sm" onClick="window.location.href = '<?php echo base_url('control/accessories_category_add') ?>'"><i class="icon-plus"></i>&nbsp;&nbsp;เพิ่มหมวดสินค้า</button></div>
                                </h5>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($categoryList->result() AS $data) {
                                            ...
                                            <tr id="row<?php echo $data->id ?>">
                                                ...
                                                <td><button type="button" class="btn btn-success btn-sm" onClick="window.location.href = '<?php echo base_url('control/accessories_category_add/' . $data->id) ?>'"><i class="icon-pencil"></i></button></td>
