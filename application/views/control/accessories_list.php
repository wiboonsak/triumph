                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">รายการสินค้า 
							...
							<div class="row">
                                ...
                                <tr id="row<?php echo $data->id?>">
                                    ...
                                    <td><?php echo $data->accessories_name?></td>
                                    <td><?php echo $data->category_title?></td>
                                    <td><button type="button" class="btn btn-success btn-sm" onClick="window.location.href='<?php echo base_url('control/accessories_add/'.$data->id)?>'"><i class="icon-pencil"></i></button></td>
                                    <td><button type="button" class="btn btn-danger btn-sm" onClick="comfirmDelete('<?php echo $data->id?>' , '<?php echo $data->accessories_name?>')"><i class="icon-trash"></i></button></td>
                                </tr>
                                <?php  $n++;  }?>
                                </tbody>
                            </table>
