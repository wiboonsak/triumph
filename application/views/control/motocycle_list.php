                        ...
                        <div class="page-title-box">
							...
							<div class="row">
                                ...
                                <tr id="row<?php echo $data->id?>">
                                    ...
                                    <td><?php echo $data->motorcycle_name?></td>
                                    <td><?php echo $data->category_title?></td>
                                    <td><button type="button" class="btn btn-success btn-sm" onClick="window.location.href='<?php echo base_url('control/motocycle_add/'.$data->id)?>'"><i class="icon-pencil"></i></button></td>
                                    <td><button type="button" class="btn btn-danger btn-sm" onClick="comfirmDelete('<?php echo $data->id?>' , '<?php echo $data->motorcycle_name?>')"><i class="icon-trash"></i></button></td>
                                </tr>
                                <?php  $n++;  }?>
                                </tbody>
                            </table>
