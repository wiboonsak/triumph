...
foreach ($cateGoryList->result() AS $category) { ?>
                                            ...
                                            <header class="categories__head clearfix">
                                                ...
                                                <?php if($cateID !=$category->category_title){?><h5 class="pull-left"><a class="no-decoration" href="<?php echo base_url('Motocycle_list/category/') .$category->id ?>"><?php echo $category->category_title ?></a></h5>
